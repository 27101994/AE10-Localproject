                ...
                <div>
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <div className="flex items-center space-x-4 text-sm text-dark-muted">
                                    <span>Room Code: <span className="font-mono text-primary-500 text-lg">{roomCode}</span></span>
                                    <span>•</span>
                    ...
                    {participantsWithStats.length === 0 ? (
                        <div className="glass-panel p-6 text-center py-16">
                            <div className="text-6xl mb-4 flex justify-center text-dark-muted"><FaHourglassHalf /></div>
                            <h3 className="text-xl font-bold text-dark-text mb-2">Waiting for participants...</h3>
                            <p className="text-dark-muted">Share the room code for others to join</p>
                        </div>
                    ) : (
